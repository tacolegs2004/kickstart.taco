...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<space>bg", require("telescope.builtin").live_grep)
...

  {
    ...
    opts = {
      ensure_installed = { "c", "lua", "vim", "vimdoc", "query", "javascript", "javascriptreact", "typescript", "typescriptreact" }
    },
    build = ':TSUpdate',
  },
